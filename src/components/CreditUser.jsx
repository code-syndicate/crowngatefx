...
const schema = Yup.object().shape({
	...
	amount: Yup.number()
		...
		.moreThan(5, "Amount must be greater than $5")
		...
		<div className="py-4">
			<div className=" border border-white/50 bg-bg1 rounded-md self-stretch shadow-md shadow-white/20">
				<p className="text-xl font-bold text-white text-left p-4">
					...
					<br />
					<small className="text-sm font-normal"> This will add to the total balance of the client </small>
				</p>
								...
								<div className=" p-4 rounded-md ">
									<div className="pb-8 space-y-6 flex flex-col justify-center items-center max-w-[400px]">
										<div className="w-full ">
											<label className="text-base text-left text-white capitalize pb-2 block">Client email</label>
											<Field type="email" name="email" className=" field pr-4 w-full " placeholder="Email Address" />
										...
										<div className="w-full">
											<label className="text-base text-left text-white capitalize pb-2 block">Amount</label>
											<Field type="number" name="amount" className=" field pr-4 w-full " placeholder="Amount" />
